...
public class PublicTransportDao {
    ...
    public void findAllPublicTransportByStatus (StatePublicTrasport statePublicTrasport){
        ...
        if (query.getResultList().isEmpty()) System.out.println("Nessun mezzo è attualmente in questo stato: " + statePublicTrasport);
    ...
    public void getAPublicTransportStatus (String id ) {
        ...
        else query.getResultList().forEach(statePublicTrasport -> System.out.println("Il mezzo con id: " + id + " è " + statePublicTrasport));
    }
